        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="order-2 lg:order-1">
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              شركة جرمه شركة ليبية متخصصة في استيراد اللحوم والمواشي، وتهدف إلى تلبية احتياجات السوق المحلي عبر تنظيم عمليات الاستيراد وفق إجراءات واضحة، مع الاهتمام بالتوثيق والبيانات الرسمية وسهولة التواصل وتعدد نقاط الوصول من خلال العنوان الرئيسي والفروع.
            </p>
